...
<div id="wrap">
    ...
    <div class="box">
        <div class="one show"  >
            <form action="admin/update_comment"  method="post">
                <p>
                ...
                <p>
                    website: <input  class="gray common" name="website" type="text" value="<?php echo $admins->website?>">
                </p>
                <p>
                    subject: <input  class="gray common" name="subject" type="text" value="<?php echo $admins->subject?>">
                </p>
                <p>
